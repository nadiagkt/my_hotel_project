...
INSERT INTO `booking` (`booking_id`, `user_id`, `room_id`, `check_in_date`, `check_out_date`, `total_price`, `created_time`) VALUES
(9, 29, 2, '2020-09-15', '2020-09-24', 5400, '2020-09-13 18:54:11'),
(10, 28, 7, '2020-09-15', '2020-09-16', 170, '2020-09-13 18:55:28');
...
INSERT INTO `favorite` (`user_id`, `room_id`, `created_time`) VALUES
(28, 2, '2020-09-13 17:22:27'),
(28, 4, '2020-09-13 18:04:30'),
(29, 2, '2020-09-13 18:54:18');
...
INSERT INTO `review` (`review_id`, `room_id`, `user_id`, `rate`, `comment`, `created_time`) VALUES
(14, 7, 28, 4, 'Nice hotel, with beautiful view!', '2020-09-13 18:56:13');
...
INSERT INTO `user` (`user_id`, `name`, `email`, `password`, `created_time`) VALUES
(28, 'nadia', 'test@gmail.gr', '$2y$10$wSs8hGGBCnrzpcmmLqUh2.TwYHuaGenpW/ijcMensIHYmRmIcmLJO', '2020-09-11 16:00:53'),
(29, 'lucy', 'lucy@gmail.gr', '$2y$10$B1U5P4iQ8sJKSilvNvcG.e4Dqy4pwWRK7/dvJBDkh/e/XIhLRDDbq', '2020-09-13 18:51:56');
